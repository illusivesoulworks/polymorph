...
public class PolymorphComponents {
  ...
  public static final ComponentKey<StackRecipeData> STACK_RECIPE_DATA =
      ComponentRegistry.getOrCreate(new Identifier(PolymorphApi.MOD_ID, "stack_recipe_data"),
          StackRecipeData.class);
  ...
  public static Optional<StackRecipeData> getRecipeData(ItemStack pStack) {
