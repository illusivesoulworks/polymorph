...
public class PolymorphPacketDistributor implements IPolymorphPacketDistributor {
  ...
  @Override
  public void sendRecipesListS2C(ServerPlayer pPlayer) {
    sendRecipesListS2C(pPlayer, null);
  }

  @Override
  public void sendRecipesListS2C(ServerPlayer pPlayer, SortedSet<IRecipePair> pRecipesList) {
  ...
  @Override
  public void sendHighlightRecipeS2C(ServerPlayer pPlayer,
  ...
  @Override
  public void sendPlayerSyncS2C(ServerPlayer pPlayer, SortedSet<IRecipePair> pRecipesList,
                                ResourceLocation pSelected) {
    PolymorphNetwork.get().send(PacketDistributor.PLAYER.with(() -> pPlayer),
