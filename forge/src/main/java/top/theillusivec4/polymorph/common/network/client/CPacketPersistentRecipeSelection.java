...
public class CPacketPersistentRecipeSelection {
  ...
  public static void encode(CPacketPersistentRecipeSelection pPacket, FriendlyByteBuf pBuffer) {
    pBuffer.writeResourceLocation(pPacket.recipe);
  }

  public static CPacketPersistentRecipeSelection decode(FriendlyByteBuf pBuffer) {
