...
public class PolymorphNetwork {
  ...
  public static void setup() {
    ...
    register(CPacketBlockEntityListener.class, CPacketBlockEntityListener::encode,
  ...
  public static <M> void register(Class<M> pClass, BiConsumer<M, FriendlyByteBuf> pEncoder,
                                  Function<FriendlyByteBuf, M> pDecoder,
